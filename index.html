<html>
    ...
    <body>
        ...
        <br><br><br><br>
           <img src="img/51.jpeg" width="100%" alt=""/>
          <div class="text" align="center">
           <h1>Misión</h1>
           <p class="text3" align="center">
               Somos una empresa dedicada a elevar el nivel de experiencias del cliente mediante el servicio de decoración y animación, generando un recuerdo único e inolvidable.
           </p>
           <br>
           <h1>Visión</h1>
           <p class="text3" align="center">
               Posicionar la marca JK Eventos como el principal proveedor de decoraciones animación mercado en el Ecuador.
