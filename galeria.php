<html>
    ...
    <body>
                ...
                <header>
                         <nav>
                            <ul id="mainmenu" class="scrollnav no-separator">
                                ...
                                <li><a href="contact-form.php" class=""><span>Contactenos</span></a></li>
        ...
        <div class="fondo">
        <img src="img/jkeventos.jpeg" width="100%" height="70%" alt=""/>
        </div>
         ...
         <div class="text" align="center">
            ...
            <p class="text2" align="center">
                 Excelente servicio para todo tipo de eventos sociales, babyshowers, fiestas infantiles. Tambien contamos con animaciòn personalizada,
                 una ambientacion agradable para la mayor comodidad y pasar el momento dando una experiencia inolvidable.
            </p>
         <br><br><br><br><br><br>   
        ...
        <div class="container2" align="center">
            ...
            <img src="img/1.jpeg" width="40%" height="70%" alt=""/>
            <img src="img/24.jpeg" width="40%" height="70%" alt=""/>
            <img src="img/51.jpeg" width="40%" height="70%" alt=""/>
            <img src="img/52.jpeg" width="40%" height="70%" alt=""/>
             <br><br><br><br>
