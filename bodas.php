<html>
    ...
    <body>
        ...
        <div class="imagenfondo" style="background-size: cover;">
             <img src="img/bd/R.jpg" width="100%" height="100%" alt=""/>
            </div>
         ...
         <div class="text" align="center">
            ...
            <p class="text2" align="center">
                "La razón para encontrar un camino en la vida, es guiarnos por nuestros sentimientos a un lugar que se sepa llamar hogar"
                Nuestros mejores deseos en su nueva etapa en la vida, y para un buen comienzo, brindamos el mejor servicio para el dia mas importante.
            </p>
         <br><br><br><br><br><br>
        ...
        <div class="container2" align="center">
            ...
            <img src="img/bd/26.jpeg" width="40%" height="70%" alt=""/>
            <img src="img/bd/43.jpeg" width="40%" height="70%" alt=""/>
            <img src="img/bd/44.jpeg" width="40%" height="70%" alt=""/>
            <img src="img/bd/45.jpeg" width="40%" height="70%" alt=""/>
            <img src="img/bd/46.jpeg" width="40%" height="70%" alt=""/>
            <img src="img/bd/50.jpeg" width="40%" height="70%" alt=""/>
